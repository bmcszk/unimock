...
func TestTransformationConfig_AddRequestTransform(t *testing.T) {
	...
	transform1 := func(data *model.MockData) (*model.MockData, error) {
		return data, nil
	}
...
func TestRequestTransformFunc_Integration(t *testing.T) {
	// Test that RequestTransformFunc works with MockData
	originalData := &model.MockData{
		Path:        "/test/123",
		IDs:         []string{"123"},
	...
	transform := func(data *model.MockData) (*model.MockData, error) {
		if data == nil {
...
func TestResponseTransformFunc_Integration(t *testing.T) {
	// Test that ResponseTransformFunc works with MockData
	originalData := &model.MockData{
		Path:        "/test/123",
		IDs:         []string{"123"},
		ContentType: "application/json",
